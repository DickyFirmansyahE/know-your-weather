  ...
  return (
    <div className="paper-container">
      <Paper
        ...
        <Typography variant="body2" color="text.secondary" sx={{ marginTop: "20px", fontSize: "18px", fontWeight: "bold" }}>Kami merupakan Tim Capstone C22-062 membuat sebuah website ini untuk dapat membantu dan memfasilitasi user agar mengetahui keadaan cuaca di daerah user berada, sehingga dapat mengantisipasi keadaan untuk kedepannya.</Typography>
